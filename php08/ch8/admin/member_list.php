...
<table width="700" border="1">
	...
	while ($record = mysql_fetch_array($result))
	{
		...
		echo '<tr>';
		echo '<td><a href="member_edit.php?no='. $record['memberNo'] .'">修改</a> / <a href="javascript: if(confirm(\'是否確定刪除？\')) {location.href=\'member_delete.php?no='. $record['memberNo'] .'\';}else{alert(\'取消刪除\')}">刪除</a></td>';
